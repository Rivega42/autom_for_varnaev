...
# ВНИМАНИЕ: это плейсхолдер. Перед продажами сгенерируйте свою пару
# (scripts/gen_license_keypair.py) и впишите сюда СВОЙ публичный ключ; приватный
# храните вне репозитория. С плейсхолдером валидных ключей не существует — все
# объекты работают в демо-режиме.
EMBEDDED_PUBLIC_KEY_HEX = "0" * 64
