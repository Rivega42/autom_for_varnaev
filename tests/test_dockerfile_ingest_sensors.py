"""Проверка Dockerfile сервиса ingest-sensors (E9.1): multi-stage, slim, non-root."""
...
_DOCKERFILE = REPO_ROOT / "services/ingest-sensors/Dockerfile"
...
def test_cmd_runs_worker() -> None:
    """CMD запускает воркер ingest_sensors.main."""
    content = _content()
    assert "ingest_sensors.main" in content
