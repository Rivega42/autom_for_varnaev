...
class ErrorCode(StrEnum):
    ...
    CLEANING_RULE_NOT_FOUND = "CLEANING_RULE_NOT_FOUND"
    CLEANING_RULE_DUPLICATE = "CLEANING_RULE_DUPLICATE"
    PRESENCE_RULE_NOT_FOUND = "PRESENCE_RULE_NOT_FOUND"
    PRESENCE_RULE_DUPLICATE = "PRESENCE_RULE_DUPLICATE"
...
ERROR_HTTP_STATUS: dict[ErrorCode, int] = {
    ...
    ErrorCode.CLEANING_RULE_NOT_FOUND: 404,
    ErrorCode.CLEANING_RULE_DUPLICATE: 409,
    ErrorCode.PRESENCE_RULE_NOT_FOUND: 404,
    ErrorCode.PRESENCE_RULE_DUPLICATE: 409,
    ErrorCode.LICENSE_LIMIT: 409,
